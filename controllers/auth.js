...
export const forgotPassword = asyncHandler(async (req, res, next) => {
  ...
  const message = `
    <p>Мы отправили вам это письмо потому что вы или кто-то еще запросил сброс пароля на сайте <Название сайта>.
      <br /> 
      Для завершения процедуры перейдите по ссылке:
    </p> 
    <a href='${resetUrl}'>Перейти на сайт <Название сайта> для сброса пароля</a>
